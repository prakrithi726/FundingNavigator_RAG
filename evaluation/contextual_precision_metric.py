...
# -----------------------------
file_path = "predicted_answers.json"  # same file as before
...
# -----------------------------
# Initialize OllamaModel (llama2)
# -----------------------------
ollama_model = OllamaModel(model="llama2:7b-chat")

# -----------------------------
# Contextual Precision Metric
# -----------------------------
metric = ContextualPrecisionMetric(model=ollama_model)
...
# Print results
# -----------------------------
print("\n✅ Contextual Precision Evaluation Complete!\n")
...
# -----------------------------
results_file = "contextual_precision_results.json"
with open(results_file, "w", encoding="utf-8") as f:
    json.dump([r.metrics_data[0].__dict__ for r in eval_results.test_results], f, indent=4)
