...
# -----------------------------
# Initialize OllamaModel (Llama2:7b-chat)
# -----------------------------
ollama_model = OllamaModel(model="llama2:7b-chat")  # use your large model

# -----------------------------
# Contextual Recall Metric
# -----------------------------
metric = ContextualRecallMetric(model=ollama_model)  # no strict/async here
...
# Print results
# -----------------------------
print("\n✅ Contextual Recall Evaluation Complete!\n")
...
# -----------------------------
results_file = "contextual_recall_results.json"
